...
urlpatterns = [
    ...
    path('',views.Company_name.as_view(),name='companies'),
    path('detail/<pk>/',views.Comany_Detail_View.as_view(),name='detail'),
    path('create/',views.CompanyCreateView.as_view()),
    #path('/update/<pk>',views.CompanyUpdateView.as_view())
    #url(r'^update/(?<pk>\d+)/$,views.CompanyUpdateView.as_view())
